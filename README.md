...
Alternatively you can run the frontend and backend servers manually by executing the commands in their respective docker files. If you do this, make sure to have a Neo4j database, with username 'neo4j' and password 'sogyopassword', running on port 7687 before you start the backend server.